"""Calendar platform for Vacances Scolaires integration."""
    ...
    def event(self):
        ...
        if self.coordinator.data["on_vacation"]:
            return CalendarEvent(
                start=datetime.fromisoformat(self.coordinator.data["start_date"]),
                end=datetime.fromisoformat(self.coordinator.data["end_date"]),
